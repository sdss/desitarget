...
from lvmtarget import io, desi_mask, targetid_mask
from lvmtarget.targets import encode_targetid, finalize
...
def is_in_ellipse_matrix(ras, decs, RAcen, DECcen, G):
    ...
    G : :class:`~numpy.ndarray`
        A 2x2 matrix to transform points measured in coordinates of the
        effective-half-light-radius to RA/Dec offset coordinates
        as generated by, e.g., :mod:`lvmtarget.skies.ellipse_matrix`
...
def model_density_of_sky_fibers(margin=10.):
    ...
    from lvmmodel.io import load_fiberpos, load_target_info
...
def select_skies(infiles, numproc=4):
    ...
    Notes
    -----
    Much of this is taken verbatim from `lvmtarget.cuts`
