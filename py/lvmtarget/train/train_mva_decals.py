"""
lvmtarget.train.train_mva_decals
=================================

- Training code developed by E. Burtin
- Update to run with DR3 by Ch. Yeche

This example can be run with the module lvmtarget/bin/qso_training
...
extract_myRF
    ...
    in a numpy array that can be read by lvmtarget.myRF class.
