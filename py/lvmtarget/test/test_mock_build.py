'''
Testing lvmtarget.mock.build, but only add_mock_shapes_and_fluxes for now
'''
...
from lvmtarget.mock.build import add_mock_shapes_and_fluxes
from lvmtarget.mock.sky import random_sky
...
class TestMockBuild(unittest.TestCase):
    ...
    def test_shapes_and_fluxes(self):
        ...
        nmock = 45
        mock = Table()
        mock['LVM_TARGET'] = 2**np.random.randint(0,3,size=nmock)
    ...
    def test_sky(self):
        ...
        surveypix = lvmmodel.footprint.tiles2pix(nside)
