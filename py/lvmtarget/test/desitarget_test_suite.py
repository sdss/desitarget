...
# -*- coding: utf-8 -*-
"""
lvmtarget.test.lvmtarget_test_suite
=================================
...
def lvmtarget_test_suite():
    """Returns unittest.TestSuite of lvmtarget tests.
...
def runtests():
    """Run all tests in lvmtarget.test.test_*.
    """
    # Load all TestCase classes from lvmtarget/test/test_*.py
    tests = lvmtarget_test_suite()
    # Run them
