...
from lvmtarget import desi_mask, bgs_mask, mws_mask, obsmask
from lvmtarget.targets import calc_priority
...
class TestPriorities(unittest.TestCase):
    ...
    def test_priorities(self):
        ...
        t['LVM_TARGET'] = desi_mask.BGS_ANY
    ...
    def test_bright_mask(self):
        t = self.targets
        t['LVM_TARGET'][0] = desi_mask.ELG
        t['LVM_TARGET'][1] = desi_mask.ELG | desi_mask.NEAR_BRIGHT_OBJECT
        t['LVM_TARGET'][2] = desi_mask.ELG | desi_mask.IN_BRIGHT_OBJECT
        p = calc_priority(t)
