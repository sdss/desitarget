...
from lvmtarget import desi_mask as Mx
from lvmtarget import obsconditions
from lvmtarget.mtl import make_mtl
...
class TestMTL(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.targets['LVM_TARGET'] = [Mx[t].mask for t in self.types]
    ...
    def test_zcat(self):
        ...
        self.targets['LVM_TARGET'][0] = Mx.BADSKY
        mtl = make_mtl(self.targets, self.zcat, trim=False)
        mtl.sort(keys='TARGETID')
