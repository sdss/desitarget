...
def isLRG_colors(gflux=None, rflux=None, zflux=None, w1flux=None,
    ...
    """See :func:`~lvmtarget.cuts.isLRG` for details.
...
def isQSO_randomforest(gflux=None, rflux=None, zflux=None, w1flux=None, w2flux=None,
    ...
    pathToRF = resource_filename('lvmtarget', "data")

    # Compute random forest probability
    from lvmtarget.myRF import myRF
...
def select_targets(infiles, numproc=4, qso_selection='randomforest',
    ...
    Returns:
        targets numpy structured array
            ...
            columns for LVM_TARGET, BGS_TARGET, and MWS_TARGET target
            selection bitmasks.
    ...
    def _finalize_targets(objects, desi_target, bgs_target, mws_target):
        ...
        targets = lvmtarget.targets.finalize(
