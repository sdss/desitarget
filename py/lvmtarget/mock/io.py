...
from lvmtarget.io import check_fitsio_version, iter_files
from lvmtarget.mock.sample import SampleGMM
from lvmutil.brick import brickname as get_brickname_from_radec
...
def read_gaussianfield(mock_dir_name, target_name, rand=None, bricksize=0.25,
    ...
    if target_name == 'SKY':
        ...
        if False:
            if target_name == 'ELG':
                from lvmtarget.cuts import isELG
