...
class SampleGMM(object):
    ...
    def __init__(self, random_state=None):
        ...
        from lvmutil.sklearn import GaussianMixtureModel

        bgsfile = resource_filename('lvmtarget', 'mock/data/bgs_gmm.fits')
        elgfile = resource_filename('lvmtarget', 'mock/data/elg_gmm.fits')
        lrgfile = resource_filename('lvmtarget', 'mock/data/lrg_gmm.fits')
        qsofile = resource_filename('lvmtarget', 'mock/data/qso_gmm.fits')
...
def sample_mag_shape(target_type, n_targets, random_state=None):
    ...
    pathToModels = resource_filename('lvmtarget', "mock/data")
